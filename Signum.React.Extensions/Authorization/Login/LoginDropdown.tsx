...
export default function LoginDropdown(p: {
  ...
  var extraButtons = p.extraButons && p.extraButons(user);
    ...
    // COM-8187: NavDropdown in react-bootstrap 2.0.2 does not accept an align prop; alignRight was removed.
  return (
    <NavDropdown className="sf-login-dropdown" id="sfLoginDropdown" title={p.renderName ? p.renderName(user) : user.userName!}>
