...
export default function FramePage() {
  ...
  function loadComponent(
    pack: EntityPack<Entity>
  ): Promise<(ctx: TypeContext<Entity>) => React.ReactElement<any>> {
  ...
  > {
    ...
    if (id) {
      ...
      return Navigator.API.fetchEntityPack(lite).then((pack) => {
        return Promise.resolve({
          pack,
          createNew: undefined
        });
  ...
  const frame: EntityFrame = {
    ...
    onReload: (pack, reloadComponent, callback) => {
      ...
      var newRoute = is(packEntity.entity, entity)
        ? null
        : packEntity.entity.isNew
        ? Navigator.createRoute(packEntity.entity.Type)
